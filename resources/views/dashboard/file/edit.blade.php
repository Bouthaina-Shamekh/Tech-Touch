                    ...
                    <form action="{{route('admin.file.update',$files->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-6 mb-3">
                                <x-form.input name="name_ar" label="{{__('Name_AR')}}" type="text" placeholder="{{__('enter name of files in arabic')}}" required :value="$files->name_ar" />
                            </div>
                            <div class="form-group col-6 mb-3">
                                <x-form.input name="name_en" label="{{__('Name_EN')}}" type="text" placeholder="{{__('enter name of files in english')}}" required :value="$files->name_en"/>
                            </div>

                            <div class="form-group col-6 mb-3">
                                <x-form.input name="title_ar" label="{{__('Title_AR')}}" type="text" placeholder="{{__('enter title of files in arabic')}}" required :value="$files->title_ar" />
                            </div>
                            <div class="form-group col-6 mb-3">
                                <x-form.input name="title_en" label="{{__('Title_EN')}}" type="text" placeholder="{{__('enter title of files in english')}}" required :value="$files->title_en"/>
                            </div>
                            ...
                            <div class="form-group col-6">
                                ...
                                <img src="{{asset('storage/' . $files->image)}}" alt="img...." width="100px" class="mt-3">
                            </div>
                        </div>
