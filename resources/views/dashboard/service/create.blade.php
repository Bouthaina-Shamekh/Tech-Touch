                ...
                <div class="card-body">
                    <form action="{{route('admin.service.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6 mb-3">
                                <x-form.input name="major_ar" label="{{__('Major_AR')}}" type="text" placeholder="{{__('enter major of services in arabic')}}"  />
                            </div>
                            <div class="form-group col-6 mb-3">
                                <x-form.input name="major_en" label="{{__('Major EN')}}" type="text" placeholder="{{__('enter major of services in english')}}"/>
                            </div>
                            <div class="form-group col-6 mb-3">
                            ...
                            <div class="form-group col-6 mb-3">
                                <label for="content_en" class="form-label">{{__('Content English')}}</label>
                                <textarea name="sub_description_en" id="sub_description_en" rows="3" class="form-control"></textarea>
                            </div>

                            <div class="form-group col-6 mb-3">
                                <label for="content_en" class="form-label">{{__('Content Arabic')}}</label>
                                <textarea name="sub_description_ar" id="sub_description_ar" rows="3" class="form-control"></textarea>
                            </div>
