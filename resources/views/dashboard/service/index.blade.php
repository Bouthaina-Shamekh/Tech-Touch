            ...
            <div class="table-responsive" style="margin: 0 15px;">
                <table class="table table-hover table-bordered" id="pc-dt-simple">
                    ...
                    <tr>
                        ...
                        <th>{{__('Sub_Description_AR')}}</th>
                        <th>{{__('Sub_Description_EN')}}</th>
                        <th>{{__('Major_AR')}}</th>
                        <th>{{__('Major_EN')}}</th>
                        <th>{{__('Image')}}</th>
                        <th>{{__('Action')}}</th>
                    ...
                    <tbody>
                        @foreach ($services as $service )
                            <tr>
                                ...
                                <td>{{$service->sub_description_en}}</td>
                                <td>{{$service->sub_description_ar}}</td>
                                <td>{{$service->major_en}}</td>
                                <td>{{$service->major_ar}}</td>
                                <td>
