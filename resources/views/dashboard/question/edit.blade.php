                    ...
                    <form action="{{ route('admin.question.update', $question->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-6 mb-3">
                                <x-form.input name="name_ar" label="{{ __('Name_AR') }}" type="text" value="{{ old('name_ar', $question->name_ar) }}" placeholder="{{ __('Enter name of the name in Arabic') }}" />
                            </div>
                            <div class="form-group col-6 mb-3">
                                <x-form.input name="name_en" label="{{ __('Name_EN') }}" type="text" value="{{ old('name_en', $question->name_en) }}" placeholder="{{ __('Enter name of the name in English') }}" />
                            </div>
                            <!-- سؤال باللغة العربية -->
                            <div class="form-group col-6 mb-3">
