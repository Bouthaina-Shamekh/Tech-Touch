                ...
                <div class="card-body">
                    <form action="{{route('admin.team.update',$teams->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6 mb-3">
                                <x-form.input name="title_ar" label="{{__('Title_AR')}}" type="text" placeholder="{{__('enter title of teams in arabic')}}" required :value="$teams->title_ar" />
                            </div>
                            <div class="form-group col-6 mb-3">
                                <x-form.input name="title_en" label="{{__('Title_EN')}}" type="text" placeholder="{{__('enter title of teams in english')}}" required :value="$teams->title_en"/>
                            </div>

                            <div class="form-group col-6 mb-3">
                                <x-form.input name="member_name_en" label="{{__('Member Name_AR')}}" type="text" placeholder="{{__('enter name of teams in arabic')}}" required :value="$teams->member_name_en" />
                            </div>
                            <div class="form-group col-6 mb-3">
                                <x-form.input name="member_name_ar" label="{{__('Member Name_EN')}}" type="text" placeholder="{{__('enter name of teams in english')}}" required :value="$teams->member_name_ar"/>
                            </div>
                            ...
                            <div class="form-group col-6 mb-3">
                                ...
                                <textarea name="description_ar" id="description_ar" rows="3" class="form-control" required>{{$teams->description_ar}}</textarea>
                            </div>
                            <div class="form-group col-6 mb-3">
                                <label for="content_en" class="form-label">{{__('Content English')}}</label>
                                <textarea name="description_en" id="description_en" rows="3" class="form-control" required>{{$teams->description_en}}</textarea>
                            </div>
