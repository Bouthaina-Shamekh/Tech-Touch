<x-dashboard-layout>
    ...
    <x-slot:breadcrumbs>
        ...
        <li class="breadcrumb-item" aria-current="page">{{__('Add About')}}</li>
    </x-slot:breadcrumb>
                ...
                <div class="card-body">
                    <form action="{{route('admin.about.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6 mb-3">
                                <x-form.input name="title_ar" label="{{__('Title_AR')}}" type="text" placeholder="{{__('enter title of about in arabic')}}"  />
                            </div>
                            <div class="form-group col-6 mb-3">
                                <x-form.input name="title_en" label="{{__('TitleEN')}}" type="text" placeholder="{{__('enter title of about in english')}}"/>
                            </div>
                            <div class="form-group col-6 mb-3">
