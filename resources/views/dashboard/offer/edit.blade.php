<x-dashboard-layout>
    ...
    <x-slot:breadcrumbs>
        ...
        <li class="breadcrumb-item" aria-current="page">{{__('Edit Offer')}}</li>
    </x-slot:breadcrumb>
    <div class="col-span-12 xl:col-span-12">
        <div class="col-md-12">
            <div class="card">
                ...
                {{-- @endcan --}}
                <div class="card-body">
                    <form action="{{route('dashboard.offer.update',$offer->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <img src="{{asset('storage/' . $offer->image)}}" alt="img...." width="100px" class="mt-3">
                            </div>

                            <div class="form-group col-6 mb-3">
                                <x-form.input name="link" label="{{__('Link')}}" type="text" placeholder="{{__('enter the link of offer')}}" required :value="$offer->link" />
                            </div>
                        </div>
