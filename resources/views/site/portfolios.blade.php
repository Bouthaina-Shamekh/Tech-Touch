    ...
    <section class="my-8">
        <div class="container">
            <div class="card-body pt-3 masonry-column">
                ...
                <div class="card__content masonry-item relative flex flex-col justify-start items-start group">
            ...
            <div class="w-full flex justify-center items-center gap-4 my-8">
                {{ $works->links() }}
                {{-- <button class="bottom__portfolios w-5 h-5 p-5 rounded-full bg-transparent border border-[#818B90] hover:bg-main hover:border-main hover:text-white hover:scale-105 transition-all delay-150 ease-in flex justify-center items-center">
                    <i class="fa-solid fa-angles-left"></i>
                </button>
                <a href="#" class="bottom__portfolios w-5 h-5 p-5 rounded-full bg-transparent text-[#818B90] border border-[#818B90] hover:bg-main hover:border-main hover:text-white hover:scale-105 transition-all delay-150 ease-in flex justify-center items-center">
                    <i class="fa-solid fa-1"></i>
                </a>
                <a href="#" class="bottom__portfolios w-5 h-5 p-5 rounded-full bg-main text-white border border-[#818B90] hover:bg-main hover:border-main hover:text-white hover:scale-105 transition-all delay-150 ease-in flex justify-center items-center">
