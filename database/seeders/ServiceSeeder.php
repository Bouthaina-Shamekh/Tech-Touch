    ...
    public function run(): void
    {
        DB::table('services')->insert([
            [
                ...
                'image' => 'images/1733291024 - services-01.png.png',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'image' => 'images/1733291024 - services-02.png.png',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'image' => 'images/1733291024 - services-03.png.png',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'description_en' => 'Lorem Ipsum Dolor Sit Amet, Consetetur Sadipscing Elitr, Sed Diam Nonumy Eirmod Tempor Invidunt',
                'description_ar' => 'نحن متخصصون في استراتيجيات التسويق الرقمي لتعزيز تواجدك على الإنترنت.',
                'image' => 'images/1733291024 - services-04.png.png',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'description_en' => 'Lorem Ipsum Dolor Sit Amet, Consetetur Sadipscing Elitr, Sed Diam Nonumy Eirmod Tempor Invidunt',
                'description_ar' => 'نحن متخصصون في استراتيجيات التسويق الرقمي لتعزيز تواجدك على الإنترنت.',
                'image' => 'images/1733291024 - services-05.png.png',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ]);
